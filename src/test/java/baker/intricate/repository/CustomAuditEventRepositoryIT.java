package baker.intricate.repository;

import baker.intricate.IntricateRankingSystemApp;
import baker.intricate.config.Constants;
import baker.intricate.config.audit.AuditEventConverter;
import baker.intricate.domain.PersistentAuditEvent;
...
import static baker.intricate.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
